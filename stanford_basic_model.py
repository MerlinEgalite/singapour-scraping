...
LETTER_IMAGES_FOLDER = "stanford_dataset/extracted_letter_images_renamed_40x40"
...
model.fit(X_train, y_train, validation_data=(X_test, y_test), batch_size=25, epochs=6, verbose=1)
